class TestData:
    test_data_one = ['Котя', 'Котов', 'Крыша, 100', 'Полянка', '79999999999', '30.04.2025', 'И не забудьте рыбку']

    test_data_two = ['Леонид', 'Тестов', 'Ленина, 16', 'Деловой центр', '79999999999', '29.04.2025', 'тест']
